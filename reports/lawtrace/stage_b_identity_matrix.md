...
| Automatic `@id` precision vs agent-reviewed **candidate** set | **1.0000** (392 edges, 0 errors) |
| Matched by `@id` | 392 |
...
## Provisional candidate succession set

`fixtures/lawtrace/candidate_gold/cap_614_section_successions.provisional.jsonl` contains all accepted edges.
...
**Terminology:** 100% precision is against the agent-reviewed candidate set, not an independent human gold standard. See `reports/lawtrace/cap614_human_audit_packet.md`.
